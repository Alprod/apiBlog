...
return [
    ...
    [ // $dynamicRoutes
        ...
        250 => [[['_route' => 'api_articles_put_updated_at_item', '_controller' => 'App\\Controller\\ArticleUpdatedAt', '_format' => null, '_stateless' => null, '_api_resource_class' => 'App\\Entity\\Article', '_api_identifiers' => ['id'], '_api_has_composite_identifier' => false, '_api_item_operation_name' => 'put_updated_at'], ['id'], ['PUT' => 0], null, false, false, null]],
        286 => [
