...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ArticleUpdatedAt' => 'getArticleUpdatedAtService',
            'App\\Controller\\UserUpdatedAt' => 'getUserUpdatedAtService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Swagger/SwaggerDecorator.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->privates['miniblog_api.event.jwt_created_listener'] ?? $this->load('getMiniblogApi_Event_JwtCreatedListenerService'));
        }, 1 => 'onJWTCreated'], 0);
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\CurrentUserForArticlesSubscriber'] ?? $this->load('getCurrentUserForArticlesSubscriberService'));
        }, 1 => 'currentUserForArticles'], 65);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\Events\\ExceptionSubscriber'] ?? $this->load('getExceptionSubscriberService'));
        }, 1 => 'processException'], 0);
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\PasswordEncoderSubscriber'] ?? $this->load('getPasswordEncoderSubscriberService'));
        }, 1 => 'encodePassword'], 33);
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\ResourceUpdaterSubscriber'] ?? $this->load('getResourceUpdaterSubscriberService'));
        }, 1 => 'check'], 65);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['miniblog.events.exception_subscriber'] ?? $this->load('getMiniblog_Events_ExceptionSubscriberService'));
        }, 1 => 'processException'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private '.1_Serializer~PPOjMbg' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1SerializerPPOjMbgService()
    {
        return $this->privates['.1_Serializer~PPOjMbg'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()))]);
    }

    /**
     * Gets the private 'App\Swagger\SwaggerDecorator' shared autowired service.
     *
     * @return \App\Swagger\SwaggerDecorator
     */
    protected function getSwaggerDecoratorService()
    {
        return $this->privates['App\\Swagger\\SwaggerDecorator'] = new \App\Swagger\SwaggerDecorator(($this->privates['App\\Swagger\\SwaggerDecorator.inner'] ?? $this->getSwaggerDecorator_InnerService()));
    }

    /**
     * Gets the private 'App\Swagger\SwaggerDecorator.inner' shared service.
     *
     * @return \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer
     */
    protected function getSwaggerDecorator_InnerService()
    {
        return $this->privates['App\\Swagger\\SwaggerDecorator.inner'] = new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer(($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), ($this->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService()), ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService()), ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService()), NULL, false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', [], $this->parameters['api_platform.swagger.api_keys'], ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~PPOjMbg'] ?? $this->get_1SerializerPPOjMbgService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0HYGkgXe2V', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LFj+Jmxk5S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ixPyaZpO6W', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fGY9eM51hQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VpG4hX73Tn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.openapi.normalizer.api_gateway.inner'] = new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~PPOjMbg'] ?? $this->get_1SerializerPPOjMbgService()));
    }
    ...
    {
        return $this->privates['api_platform.swagger.normalizer.api_gateway'] = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(($this->privates['App\\Swagger\\SwaggerDecorator'] ?? $this->getSwaggerDecoratorService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WA98zju4Gy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('55yHHGnTFT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultMetadataDriverService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Persistence\Mapping\Driver\SymfonyFileLocator([(\dirname(__DIR__, 4).'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/orm/doctrine-orm') => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', (\dirname(__DIR__, 4).'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/orm/doctrine-entity') => 'Gesdinet\\JWTRefreshTokenBundle\\Entity'], '.orm.xml'));

        $instance->addDriver($a, 'App\\Entity');
        $instance->addDriver($a, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
        $instance->addDriver($b, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
        $instance->addDriver($b, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
    ...
    protected function getPropertyAccessorService()
    {
        ...
        return $this->privates['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(3, false, ($this->privates['cache.property_access'] ?? ($this->privates['cache.property_access'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter(0, false))), true, $a, $a);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['security.authentication.provider.guard.users'] ?? $this->load('getSecurity_Authentication_Provider_Guard_UsersService'));
            yield 3 => ($this->privates['security.authentication.provider.guard.articles'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ArticlesService'));
            ...
            yield 5 => ($this->privates['security.authentication.provider.anonymous.refresh'] ?? ($this->privates['security.authentication.provider.anonymous.refresh'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 6), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.users' => ($this->privates['.security.request_matcher.CN_4GzD'] ?? ($this->privates['.security.request_matcher.CN_4GzD'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users', NULL, [0 => 'PUT', 1 => 'PATCH', 2 => 'DELETE'])));
            yield 'security.firewall.map.context.articles' => ($this->privates['.security.request_matcher.KRuynPj'] ?? $this->load('get_Security_RequestMatcher_KRuynPjService'));
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'gesdinet_jwt_refresh_token.ttl': $value = $this->getEnv('int:JWT_REFRESH_TTL'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.users._indexed_authenticators' => [

            ],
            'security.articles._indexed_authenticators' => [
