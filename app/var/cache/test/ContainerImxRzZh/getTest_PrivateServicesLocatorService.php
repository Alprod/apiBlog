...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Auth\\AuthentificationChecker' => ['privates', 'App\\Auth\\AuthentificationChecker', 'getAuthentificationCheckerService', true],
            'App\\Auth\\AuthentificationCheckerInterface' => ['privates', 'App\\Auth\\AuthentificationChecker', 'getAuthentificationCheckerService', true],
            'App\\Auth\\ResourceAccessChecker' => ['privates', 'App\\Auth\\ResourceAccessChecker', 'getResourceAccessCheckerService', true],
            'App\\Auth\\ResourceAccessCheckerInterface' => ['privates', 'App\\Auth\\ResourceAccessChecker', 'getResourceAccessCheckerService', true],
            'App\\DataFixtures\\AppFixtures' => ['privates', 'App\\DataFixtures\\AppFixtures', 'getAppFixturesService', true],
            'App\\DataPersister\\Article' => ['privates', 'App\\DataPersister\\Article', 'getArticle2Service', true],
            'App\\DataPersister\\Article.inner' => ['privates', 'App\\DataPersister\\Article.inner', 'getArticle_InnerService', true],
            'App\\Events\\CurrentUserForArticlesSubscriber' => ['privates', 'App\\Events\\CurrentUserForArticlesSubscriber', 'getCurrentUserForArticlesSubscriberService', true],
            'App\\Events\\ExceptionSubscriber' => ['privates', 'App\\Events\\ExceptionSubscriber', 'getExceptionSubscriberService', true],
            'App\\Events\\PasswordEncoderSubscriber' => ['privates', 'App\\Events\\PasswordEncoderSubscriber', 'getPasswordEncoderSubscriberService', true],
            'App\\Events\\ResourceUpdaterSubscriber' => ['privates', 'App\\Events\\ResourceUpdaterSubscriber', 'getResourceUpdaterSubscriberService', true],
            'App\\Factory\\Email' => ['privates', 'App\\Factory\\Email', 'getEmailService', true],
            'App\\Factory\\EmailInterface' => ['privates', 'App\\Factory\\Email', 'getEmailService', true],
            'App\\Factory\\JsonResponse' => ['privates', 'App\\Factory\\JsonResponse', 'getJsonResponseService', true],
            'App\\Factory\\JsonResponseInterface' => ['privates', 'App\\Factory\\JsonResponse', 'getJsonResponseService', true],
            ...
            'App\\Services\\ExceptionNormaliserFormatterInterface' => ['privates', 'App\\Services\\ExceptionNormalizerFormatter', 'getExceptionNormalizerFormatterService', true],
            'App\\Services\\ExceptionNormalizerFormatter' => ['privates', 'App\\Services\\ExceptionNormalizerFormatter', 'getExceptionNormalizerFormatterService', true],
            'App\\Services\\ResourceUpdater' => ['privates', 'App\\Services\\ResourceUpdater', 'getResourceUpdaterService', true],
            'App\\Services\\ResourceUpdaterInterface' => ['privates', 'App\\Services\\ResourceUpdater', 'getResourceUpdaterService', true],
            'App\\Swagger\\SwaggerDecorator' => ['privates', 'App\\Swagger\\SwaggerDecorator', 'getSwaggerDecoratorService', false],
            'App\\Swagger\\SwaggerDecorator.inner' => ['privates', 'App\\Swagger\\SwaggerDecorator.inner', 'getSwaggerDecorator_InnerService', false],
            ...
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService', true],
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService', true],
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_exists_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_exists_filter', 'getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterExistsFilterService', true],
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService', true],
            ...
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService', true],
            ...
            'api_platform.doctrine.orm.data_persister' => ['privates', 'App\\DataPersister\\Article', 'getArticle2Service', true],
            ...
            'api_platform.swagger.normalizer.api_gateway.inner' => ['privates', 'App\\Swagger\\SwaggerDecorator', 'getSwaggerDecoratorService', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.Gw73EI_', 'get_ServiceLocator_Gw73EIService', true],
            ...
            'miniblog.events.exception_subscriber' => ['privates', 'miniblog.events.exception_subscriber', 'getMiniblog_Events_ExceptionSubscriberService', true],
            'miniblog.normalizer.authentification_exception' => ['privates', 'miniblog.normalizer.authentification_exception', 'getMiniblog_Normalizer_AuthentificationExceptionService', true],
            'miniblog.normalizer.authentification_not_found_exception' => ['privates', 'miniblog.normalizer.authentification_not_found_exception', 'getMiniblog_Normalizer_AuthentificationNotFoundExceptionService', true],
            'miniblog.normalizer.resource_access_exception' => ['privates', 'miniblog.normalizer.resource_access_exception', 'getMiniblog_Normalizer_ResourceAccessExceptionService', true],
            'miniblog_api.event.jwt_created_listener' => ['privates', 'miniblog_api.event.jwt_created_listener', 'getMiniblogApi_Event_JwtCreatedListenerService', true],
            ...
            'security.authentication.listener.anonymous.refresh' => ['privates', 'security.authentication.listener.anonymous.refresh', 'getSecurity_Authentication_Listener_Anonymous_RefreshService', true],
            'security.authentication.listener.guard.articles' => ['privates', 'security.authentication.listener.guard.articles', 'getSecurity_Authentication_Listener_Guard_ArticlesService', true],
            'security.authentication.listener.guard.users' => ['privates', 'security.authentication.listener.guard.users', 'getSecurity_Authentication_Listener_Guard_UsersService', true],
            ...
            'security.authentication.provider.anonymous.refresh' => ['privates', 'security.authentication.provider.anonymous.refresh', 'getSecurity_Authentication_Provider_Anonymous_RefreshService', true],
            ...
            'security.authentication.provider.guard.articles' => ['privates', 'security.authentication.provider.guard.articles', 'getSecurity_Authentication_Provider_Guard_ArticlesService', true],
            'security.authentication.provider.guard.users' => ['privates', 'security.authentication.provider.guard.users', 'getSecurity_Authentication_Provider_Guard_UsersService', true],
            ...
            'security.authentication.session_strategy.articles' => ['privates', 'security.authentication.session_strategy_noop', 'getSecurity_Authentication_SessionStrategyNoopService', true],
            ...
            'security.authentication.session_strategy.refresh' => ['privates', 'security.authentication.session_strategy_noop', 'getSecurity_Authentication_SessionStrategyNoopService', true],
            'security.authentication.session_strategy.users' => ['privates', 'security.authentication.session_strategy_noop', 'getSecurity_Authentication_SessionStrategyNoopService', true],
            ...
            'security.exception_listener.articles' => ['privates', 'security.exception_listener.articles', 'getSecurity_ExceptionListener_ArticlesService', true],
            ...
            'security.exception_listener.refresh' => ['privates', 'security.exception_listener.refresh', 'getSecurity_ExceptionListener_RefreshService', true],
            'security.exception_listener.users' => ['privates', 'security.exception_listener.users', 'getSecurity_ExceptionListener_UsersService', true],
            ...
            'security.firewall.map.config.articles' => ['privates', 'security.firewall.map.config.articles', 'getSecurity_Firewall_Map_Config_ArticlesService', true],
            ...
            'security.firewall.map.config.refresh' => ['privates', 'security.firewall.map.config.refresh', 'getSecurity_Firewall_Map_Config_RefreshService', true],
            'security.firewall.map.config.users' => ['privates', 'security.firewall.map.config.users', 'getSecurity_Firewall_Map_Config_UsersService', true],
            'security.firewall.map.context.articles' => ['privates', 'security.firewall.map.context.articles', 'getSecurity_Firewall_Map_Context_ArticlesService', true],
            ...
            'security.user_checker.articles' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            ...
            'security.user_checker.refresh' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            'security.user_checker.users' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            ...
            'twig.extension.dump' => ['privates', 'twig.extension.dump', 'getTwig_Extension_DumpService', true],
            ...
            'var_dumper.html_dumper' => ['privates', 'var_dumper.html_dumper', 'getVarDumper_HtmlDumperService', true],
            ...
            'App\\Auth\\AuthentificationChecker' => '?',
            'App\\Auth\\AuthentificationCheckerInterface' => '?',
            'App\\Auth\\ResourceAccessChecker' => '?',
            'App\\Auth\\ResourceAccessCheckerInterface' => '?',
            'App\\DataFixtures\\AppFixtures' => '?',
            'App\\DataPersister\\Article' => '?',
            'App\\DataPersister\\Article.inner' => '?',
            'App\\Events\\CurrentUserForArticlesSubscriber' => '?',
            'App\\Events\\ExceptionSubscriber' => '?',
            'App\\Events\\PasswordEncoderSubscriber' => '?',
            'App\\Events\\ResourceUpdaterSubscriber' => '?',
            'App\\Factory\\Email' => '?',
            'App\\Factory\\EmailInterface' => '?',
            'App\\Factory\\JsonResponse' => '?',
            'App\\Factory\\JsonResponseInterface' => '?',
            'App\\Repository\\ArticleRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Services\\ExceptionNormaliserFormatterInterface' => '?',
            'App\\Services\\ExceptionNormalizerFormatter' => '?',
            'App\\Services\\ResourceUpdater' => '?',
            'App\\Services\\ResourceUpdaterInterface' => '?',
            ...
            'Twig\\Environment' => '?',
            'Twig_Environment' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_exists_filter' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_range_filter' => '?',
            ...
            'miniblog.normalizer.authentification_not_found_exception' => '?',
            ...
            'security.authentication.listener.anonymous.refresh' => '?',
            'security.authentication.listener.guard.articles' => '?',
            'security.authentication.listener.guard.users' => '?',
            ...
            'security.authentication.provider.anonymous.refresh' => '?',
            'security.authentication.provider.dao.login' => '?',
            'security.authentication.provider.guard.articles' => '?',
            'security.authentication.provider.guard.users' => '?',
            'security.authentication.retry_entry_point' => '?',
            'security.authentication.session_strategy' => '?',
            'security.authentication.session_strategy.articles' => '?',
            'security.authentication.session_strategy.login' => '?',
            'security.authentication.session_strategy.main' => '?',
            'security.authentication.session_strategy.refresh' => '?',
            'security.authentication.session_strategy.users' => '?',
            ...
            'security.exception_listener.articles' => '?',
            'security.exception_listener.login' => '?',
            'security.exception_listener.main' => '?',
            'security.exception_listener.refresh' => '?',
            'security.exception_listener.users' => '?',
            'security.expression_language' => '?',
            'security.firewall' => '?',
            'security.firewall.map' => '?',
            'security.firewall.map.config.articles' => '?',
            'security.firewall.map.config.dev' => '?',
            'security.firewall.map.config.login' => '?',
            'security.firewall.map.config.main' => '?',
            'security.firewall.map.config.refresh' => '?',
            'security.firewall.map.config.users' => '?',
            'security.firewall.map.context.articles' => '?',
            ...
            'security.user_checker.articles' => '?',
            'security.user_checker.login' => '?',
            'security.user_checker.main' => '?',
            'security.user_checker.refresh' => '?',
            'security.user_checker.users' => '?',
